...
public class DZRenderPipeline_Simple : RenderPipeline
{
    ...
    public DZRenderPipeline_Simple(
    ...
    void PreCullScene(ScriptableRenderContext context, Camera camera)
    {
