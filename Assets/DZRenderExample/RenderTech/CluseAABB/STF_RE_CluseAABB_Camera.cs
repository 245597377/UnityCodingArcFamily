...
namespace STFEngine.Render.Example
{
    ...
    public class STF_RE_CluseAABB_Camera : MonoBehaviour
    {
        ...
        void InitSceneObject()
        {
            ...
            {
                Material mtl = new Material(Shader.Find("RenderExample/Tech/Cluster/DrawSceneColor"));
                //Material mtl = new Material(Shader.Find("Unlit/Texture"));
                mtl.SetTexture("_MainTex", mr.sharedMaterial.GetTexture("_MainTex"));
                lst_Mtl.Add(mtl);
            }
        }
    }
